...
- [Global state management with **React Context**](#react-context)
- [Global state management with **Recoil**](#recoil)
...
## React Context <a name="react-context"></a>

[Context Docs](https://reactjs.org/docs/context.html#when-to-use-context)
...
- ✅ Often used under the hood by other state management libraries
